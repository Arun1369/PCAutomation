...
public class DriverClass {
	...
	{
		String  filepath = System.getProperty("user.dir")+"\\src\\main\\java\\Config\\PepperCloudCRM.properties";
	 ...
	 * 
	 */
	protected void launchBrowser(String browserName) throws IOException
	{
		switch (browserName)
		{
		case "FF":
