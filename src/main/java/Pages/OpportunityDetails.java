...
public class OpportunityDetails extends DriverClass{
	...
	public By EditButtonInDetailsPage = By.xpath(
			"//div[contains(@class,'show-grid pc_slds-show-gridd pc_panel slds-float_right')]//button[1]");
		...
		public By OpportunityNameDetailsHeader = By.xpath("//span[@class='pc_lead-name pc-word-wrap ']");
		public By AccountNameDetailsHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[1]");
		public By AmountDetailsHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[2]");
		public By StatusDetailsHeader= By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[3]");
		public By AssignedToDetailsHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[4]");
