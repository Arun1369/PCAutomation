...
public class ContactDetails extends DriverClass{
	...
	public By EditButtonInDetailsPage = By.xpath(
		...
		public By ContactNameDetailsHeader = By.xpath("//span[@class='pc_lead-name pc-word-wrap ']");
		public By AccountNameDetailsHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[1]");
		public By DesignationDetailsHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[2]");
		public By MobileNumberDetailsHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[3]");
		public By EmailInfoHeader = By.xpath("(//div[@class='slds-opportunity-CompName pc-word-wrap slds-text-heading_small'])[4]");
